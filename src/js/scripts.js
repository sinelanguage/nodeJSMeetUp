...
( function ( $, window, document, undefined ) {
	...
	// What if my library or fn or built in fn do not return promises, how do I make a raw promise out of it?
	// Using Q lib:

	function fs_readFile (file, encoding) {
	  var deferred = Q.defer()
	  fs.readFile(file, encoding, function (err, data) {
	    if (err) deferred.reject(err) [1]
	    else deferred.resolve(data) [2]
	  })
